...
rna_gene("yellow_hub.txt")
rna_gene("black_hub.txt")
rna_gene("brown_hub.txt")
rna_gene("blue_hub.txt")
rna_gene("turquoise_hub.txt")
rna_gene("green_hub.txt")
rna_gene("red_hub.txt")


module_transform("rna_yellow_hub.txt")
module_transform("rna_black_hub.txt")
module_transform("rna_brown_hub.txt")
module_transform("rna_blue_hub.txt")
module_transform("rna_turquoise_hub.txt")
module_transform("rna_green_hub.txt")
module_transform("rna_red_hub.txt")
