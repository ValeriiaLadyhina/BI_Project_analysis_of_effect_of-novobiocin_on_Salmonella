...
rna_gene("brown.txt")
rna_gene("blue.txt")
rna_gene("turquoise.txt")
rna_gene("green.txt")
rna_gene("red.txt")


module_transform("rna_yellow_deg.txt")
module_transform("rna_black_deg.txt")
module_transform("rna_brown.txt")
module_transform("rna_blue_deg.txt")
module_transform("rna_turquoise_deg.txt")
module_transform("rna_green_deg.txt")
module_transform("rna_red_deg.txt")